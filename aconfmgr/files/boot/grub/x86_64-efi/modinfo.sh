...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 13.1.1 20230429'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/13.1.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
grub_package_version="2.06.r499.ge67a551a4-4"
